...
class _CartScreenState extends State<CartScreen> {
  ...
  List<String> images = [
    ...
    'assets/images/border-from-fresh-fruits.jpg',
    'assets/images/making-homemade-burger-ingredients-cooking-wooden-table-top-view-flat-lay-copy-space.jpg',
    'assets/images/healthy-vegetables-full-vitamins-with-copy-space.jpg',
  ];
  int currentPage = 0;
  @override
  void initState() {
            ...
            children: [
              Container(
                ...
                child: ListTile(
                  ...
                  trailing: Image.asset('assets/images/Group4 - copy.png'),
                ),
              ),
              SizedBox(height: 10,),
              Container(
              ...
              GridView.count(
                ...
                children: [
                  ...
                  CartItem(color: Colors.green[100],
                    ...
                    image: 'assets/images/green-fresh-broccoli.png',
                    price: '3.00',
                    weight: '1 kg',
                  ),
                ],
